...
export default function Home() {
  ...
  const industries = [
    ...
    { title: "Customer Center", img: "/images/Customer.JPG" },
  ...
  return (
    <div ref={ref} className="min-h-screen text-gray-900 overflow-hidden relative">
      ...
      <div className="relative bg-gradient-to-b from-purple-50 via-white-200 to-white">
        ...
        >
          <motion.h2 className="text-5xl md:text-7xl font-light leading-tight mb-3">
        ...
        <section className="relative z-10 py-12 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:pr-10 lg:pr-20">
            <h3 className="text-5xl font-bold mb-1 text-black">
              Why Choose LATAM?
            </h3>

            <p className="text-lg text-gray-700 mb-4">
              Latin America is a smart choice for building remote teams not just
              to reduce costs, but to scale sustainably with the right talent and
              cultural alignment.
            </p>
