...
export default function OurOffices() {
  const images = [
    { title: "", img: "/images/banos.png" },
    { title: "", img: "/images/sala.JPG" },
    { title: "", img: "/images/lokers.png" },
    { title: "", img: "/images/morePeople.JPG" },
  ];
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 overflow-hidden text-gray-900">
      ...
      {/* Sección Experience */}
      <section className="relative mt-0 py-24 bg-gradient-to-br from-purple-50 via-white to-purple-100 overflow-hidden">
